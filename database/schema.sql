...
-- ============================================================
-- DP KIOSK DATABASE SCHEMA (MySQL)
-- Run this with: mysql -u kiosk_user -p dp_kiosk_db < schema.sql
-- Or use the automated setup.js script
-- ============================================================
...
CREATE TABLE users (
    ...
    email_encrypted TEXT,  -- ✅ KEEP THIS ONLY
...
-- ============================================================
-- ADMIN USERS TABLE - UPDATED WITH FULL_NAME COLUMN
-- ============================================================
CREATE TABLE IF NOT EXISTS admin_users (
    id INT PRIMARY KEY AUTO_INCREMENT,
    username VARCHAR(50) UNIQUE NOT NULL,
    full_name VARCHAR(100) DEFAULT NULL,  -- ✅ ADDED THIS COLUMN
...
-- ============================================================
-- SAVED THEMES TABLE (NEW - USER CUSTOM THEMES)
-- ============================================================
...
-- Note: This is plain text password, will be hashed by setup.js
...
-- Insert sample questions (keeping 'rating' as you requested)
