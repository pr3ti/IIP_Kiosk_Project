...
/**
 * ✅ NEW FUNCTION: Decrypt emails in feedback array
 */
...
async function generateFeedbackExcel(data, title) {
    // For simplicity, convert to CSV (you can add xlsx library for true Excel)
    const rows = [];
    ...
    const headers = [
        'Feedback ID',
        'User Name',
        'Email', // ✅ Changed from "Email (Encrypted)" to just "Email"
        'Visit Count',
        'Comment/Pledge',
        'Data Retention',
        'Photo Path',
