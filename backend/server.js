...
app.post('/api/upload-photo', upload.single('photo'), async (req, res) => {
  try {
    ...
    const result = await imageProcessor.processUserPhoto(photoBuffer, req.body.userName, req.fileUniqueId);
...
app.listen(PORT, () => {
  ...
  console.log(`🖼️ Overlay path: ${path.join(backendDir, 'assets', 'backgrounds', 'overlay.png')}`);
  ...
  console.log(`   http://localhost:${PORT}/api/admin/cleanup-status - Cleanup status`);
