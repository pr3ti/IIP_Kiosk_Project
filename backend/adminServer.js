// adminServer.js - Admin server (Admin UI + Admin API) on PORT 3001
...
// ✅ ADDED: Tree + Leaderboard routes (data fetching only)
...
// ✅ ADDED: Wire DB into treeRoutes (this is often why server.js works but adminServer doesn’t)
setTreeDatabase(db);
...
// ✅ ADDED: Tree data fetching for Digital Tree tab
app.use('/api/tree', treeRoutes);

// ✅ ADDED: Leaderboard data fetching for Leaderboard tab
